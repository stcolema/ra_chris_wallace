...
\begin{document} \pgfplotsset{compat=1.15}
	...
	\begin{abstract}
		Gene sets are constructed to identify genes linked by 
		...
		There exists an abundance of gene set databases \cite{szklarczyk_string_2019}\cite{subramanian_gene_2005}\cite{kanehisa_new_2019}\cite{ashburner_gene_2000}. 
		
		Tissue specific \cite{the_multiple_tissue_human_expression_resource_muther_consortium_mapping_2012} \cite{burgess_gene_2017}
