...
###Data can be downloaded from the TCGA Data Portal at link https://tcga-data.nci.nih.gov/docs/publications/brca_2012/
...
save(processedExpression , 'processedExpression.RDa')
save(processedMethylation, 'processedMethylation.RDa')
save(processedmiRNA      , 'processedmiRNA.RDa')
save(processedProtein    , 'processedProtein.RDa')
