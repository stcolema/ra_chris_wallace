...
# For Bayesian clustering output (possibly should use mcclust)
...
input_arguments <- function() {
  option_list <- list(
    ...
    optparse::make_option(c("--probe_key"),
                          type = "string",
                          default = "/home/MINTS/sdc56/Desktop/Analysis/probe_key.csv",
...
probes_present_dt <- args$probe_present
...
phis <- list()
count <- 0
start_index <- burn # Consider letting this equal "burn"
