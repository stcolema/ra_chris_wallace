...
mdi_output_files <- paste0(file_path, "CD14_sma_mat_nv_CD19_sma_mat_nv_CD4_sma_mat_nv_CD8_sma_mat_nv_IL_sma_mat_nv_RE_sma_mat_nv_TR_sma_mat_nv_4_mcmcSamples.csv")
