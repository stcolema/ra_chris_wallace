...
tib_all <- readRDS("~/Desktop/Final_set/Analysis/compare_tibble.rds")


# tissue_type <- c("CD", "Colon")

all_dir <- paste0("~/Desktop/Final_set/Analysis/")
...
gen_ph_name <- paste0("comparison_specific_sim_cor.png")
gen_ph_no_cor_name <- paste0("comparison_specific_sim.png")
